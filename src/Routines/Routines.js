function spellNumber(language, value) {
    if (language === 'EN') {
        return numberToEnglish(value)
    }
    if (language === 'RU') {
        return numberToRussian(value)
...
//   http://shpargalkablog.ru/2017/05/writing-number-letters.html
// https://github.com/meritt/rubles/issues
// https://gist.github.com/Shutik/908b8ce4ce432540e14bd8927e2edeb1
